...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu( id = "rted_menu",
                 ...
                 menuItem(i18n$t("Newfoundland and Labrador"),tabName = "NFL", icon = icon("chart-bar")),
...
font-style: italic;
    ...
    tabItems(
              ...
              fluidPage( id = "dashboard_page",
                         fluidRow(div(h1(id = "header_title",i18n$t("High-frequency electricity data (HFED): Interactive dashboard")),
                                      div(id = "lang_btn",
                                          ...
                                          bsButton("Btn_FR","Français",icon = icon("language"),style = "primary",size = "small",type = "action"),
                                          bsButton("Btn_acc",i18n$t("Accessibility"),icon = icon("universal-access"),style = "primary",size = "small",type = "action"),
                                      ...
                                      fluidRow(
                                        box(
                                          title = fluidRow(id = "dash_title",
                                                           fluidRow(column(width = 8, h4(i18n$t("Newfoundland and Labrador"))),column(width = 12, id="nflmean",uiOutput("NFL_MEAN")))),
                                          width = 6, status = "success", solidHeader = TRUE,
                                          collapsible = TRUE,
                                          column(
                                            fluidRow(withLoader(uiOutput("NFL_load"), type = "html", loader = "loader3")),
                                            fluidRow(bsButton("button_NFL",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)
                                        ),
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_pei",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                      ),
                                      fluidRow(
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_NS",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_NB",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                      ),
                                      fluidRow(
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_QB",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_ON",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                      ),
                                      fluidRow(
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_AB",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                        box(
                                          title = fluidRow(id = "dash_title",
                                          ...
                                          column(
                                            ...
                                            fluidRow(bsButton("button_BC",i18n$t("For more detailed information, click here"), icon = icon("chart-bar"), style = "primary", block = TRUE)),width = 12)),
                                      ))))),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Prince Edward Island")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_pei","Français",icon = icon("language"),style = "primary",size = "small",type = "action"),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   fluidRow(
                                     column(width = 10, helpText(i18n$t("Note: Selecting longer date range or frequency like daily, hourly can take longer time to render graphs."))),
                                     column(width = 2, bsButton("button_pei_ind_1",i18n$t("Download Data"), icon = icon("download"), style = "primary", block = TRUE))
                                   )
                                 ))),
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = i18n$t("Generation by Type"), width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_pei_2", h4(i18n$t("Frequency")),
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                         ...
                         fluidRow(
                           column(width =10, offset = 2,
                                  box(
                                    title = "Wind Power", width = 10, status = "warning", solidHeader = TRUE,
                                    collapsible = TRUE,
                                    fluidRow(column(width = 2, selectInput("select_fr_pei_3", h4(i18n$t("Frequency")), 
                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                         ...
                         fluidRow(
                           column(width =10, offset = 2,
                                  box(
                                    title = "Percentage of load generated from wind", width = 10, status = "warning", solidHeader = TRUE,
                                    collapsible = TRUE,
                                    fluidRow(column(width = 2, selectInput("select_fr_pei_4", h4(i18n$t("Frequency")), 
                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Nova Scotia")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_ns","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ns", h4(i18n$t("Frequency")), 
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ns_1", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ns_2", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ns_3", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("New Brunswick")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_nb","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(column(width =10, offset = 2,
                                                  box(
                                                    title = "Load", width = 10, status = "warning", solidHeader = TRUE,
                                                    collapsible = TRUE,
                                                    fluidRow(column(width = 2, selectInput("select_fr_nb", h4(i18n$t("Frequency")), 
                                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
                                         ...
                                         fluidRow(
                                           column(width =10, offset = 2,
                                                  box(
                                                    ...
                                                    collapsible = TRUE,
                                                    fluidRow(column(width = 2, selectInput("select_fr_nb_2", h4(i18n$t("Frequency")), 
                                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
                                         ...
                                         fluidRow(
                                           column(width =10, offset = 2,
                                                  box(
                                                    ...
                                                    collapsible = TRUE,
                                                    fluidRow(column(width = 2, selectInput("select_fr_nb_3", h4(i18n$t("Frequency")), 
                                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
                                         ...
                                         fluidRow(
                                           column(width =10, offset = 2,
                                                  box(
                                                    ...
                                                    collapsible = TRUE,
                                                    fluidRow(column(width = 2, selectInput("select_fr_nb_4", h4(i18n$t("Frequency")), 
                                                                                           choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "5 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Ontario")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_on","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_on1", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_on2", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
      ...
      tabItem(tabName = "NFL",
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Newfoundland and Labrador")),
                                     div(id = "lang_btn",
                                         bsButton("Btn_EN_nfl","English",icon = icon("language"),style = "primary",size = "small",type = "action"),
                                         bsButton("Btn_FR_nfl","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = "Load", width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_nfl", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Quebec")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_qb","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = "Demand", width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_1", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_2", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_3", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_4", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_5", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_6", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_qb_7", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("Alberta")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_ab","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = "Hydro", width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_8", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_9", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = "Solar", width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_10", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   title = "Wind", width = 10, status = "warning", solidHeader = TRUE,
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_11", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_12", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_13", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_ab_14", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
              ...
              fluidPage(id = "dashboard_page",
                        fluidRow(div(h2(id = "header_title",i18n$t("British Columbia")),
                                     div(id = "lang_btn",
                                         ...
                                         bsButton("Btn_FR_bc","Français",icon = icon("language"),style = "primary",size = "small",type = "action")))),
                        ...
                        fluidRow(
                          column(width =10, offset = 2,
                                 box(
                                   ...
                                   collapsible = TRUE,
                                   fluidRow(column(width = 2, selectInput("select_fr_bc_1", h4(i18n$t("Frequency")), 
                                                                          choices = list("Yearly" = 1,"Weekly" = 3, "Daily" = 4, "Hourly" = 5, "15 Min" = 6), selected = 6)),
              ...
              fluidPage(
                box(title = "Downloads", status = "success", solidHeader = TRUE, width = "100%", collapsible = FALSE,
                    fluidRow(
                      ...
                      column(width = 2,
                             conditionalPanel(condition = "input.prvnc_list == 'Newfoundland and Labrador'",
                             ...
                             conditionalPanel(condition = "input.prvnc_list == 'Alberta'",
                                              selectInput("enf_flow_ab",h3("Energy Flow"),choices = list("INTERNAL_LOAD"))),
                      ...
                      fluidRow(
                      column(width = 12,
                      downloadBttn("button_dwnld",i18n$t("Download data"),"unite","primary","md",TRUE,TRUE,icon("download"))
                      ))
                    ) 
...
#bussines logic fdi-stable-sdmx.aaw-dev.cloud.statcan.ca

base_url_prefix <- "https://fdi-design-sdmx.aaw.cloud.statcan.ca/rest/data/CCEI,"
#base_url_prefix <- "https://fdi-stable-sdmx.aaw-dev.cloud.statcan.ca/rest/data/CCEI,"
...
server <- function(input, output, session) {
  ...
  observeEvent(nb_stat_api(),{
      ...
      observeEvent(nbload_data_pre(),{
        ...
        if(nbload_data_mean_prcnt() < 0){
          ...
          output$NB_MEAN <- renderUI({HTML(paste("<h4 i18n><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(nbload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }
        if(nbload_data_mean_prcnt() > 0){
          removeClass("nbmean","red_output")
          addClass("nbmean","green_output")
          output$NB_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(nbload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }})
      ...
      output$NB_load <- renderUI({
        ...
        highchart(height = 400) %>% 
          ...
          hc_add_series(nb_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>%
  ...
  observeEvent(ns_stat_api(),{
    if(setequal(ns_status(),200)){
      ...
      # Changed to "H" https://jirab.statcan.ca/browse/CODAS-1837
      test_ns_dat <<- dataset("DF_HFED_NS","CA_NS","H","LOAD",NULL,NULL,1) %>% arrange(desc(DATETIME_LOCAL)) %>% collect()
      ...
      if((as.Date(test_ns_dat$DATETIME_LOCAL) == as.Date(Sys.time()))||(as.Date(test_ns_dat$DATETIME_LOCAL) == as.Date(Sys.time())-1))
      {
        ...
        log_info("Using Latest Data for NS")
      ...
      else
      {
        ...
        log_info("Using Nrow Data for NS")
      ...
      observeEvent(nsload_data_pre(),{
        ...
        if(nsload_data_mean_prcnt() < 0){
          ...
          output$NS_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(nsload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }
        if(nsload_data_mean_prcnt() > 0){
          removeClass("nsmean","red_output")
          addClass("nsmean","green_output")
          output$NS_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(nsload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }})
      ...
      output$NS_load <- renderUI({
        highchart(height = 400) %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(ns_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>%
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
  ...
  observeEvent(bcload_data_pre(),{
    ...
    if(bcload_data_mean_prcnt() < 0){
      ...
      output$BC_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(bcload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
    }
    if(bcload_data_mean_prcnt() > 0){
      removeClass("bcmean","red_output")
      addClass("bcmean","green_output")
      output$BC_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(bcload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
    }})
  ...
  output$BC_load <- renderUI({
    highchart(height = 400) %>% 
      hc_xAxis(type = "datetime") %>%
      hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
      hc_add_series(bc_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>% 
      hc_plotOptions(series = list(turboThreshold = 1)) %>%
      hc_navigator(enabled = TRUE)})
    ...
    if(on_status() == 200){
      ...
      observeEvent(onload_data_pre(),{
        ...
        if(onload_data_mean_prcnt() < 0){
          ...
          output$ON_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(onload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }
        if(onload_data_mean_prcnt() > 0){
          removeClass("onmean","red_output")
          addClass("onmean","green_output")
          output$ON_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(onload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</span></h4>"))})
        }})
      ...
      output$ON_load <- renderUI({
        highchart(height = 400) %>% 
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(on_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>% 
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
    ...
    if(pei_status() == 200){
      ...
      observeEvent(peiload_data_pre(),{
        ...
        if(peiload_data_mean_prcnt() < 0){
          ...
          output$PEI_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(peiload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }
        if(peiload_data_mean_prcnt() > 0){
          removeClass("peimean","red_output")
          addClass("peimean","green_output")
          output$PEI_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(peiload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }})
      ...
      output$PEI_load <- renderUI({
        highchart(height = 400) %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(pei_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>%
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
    ...
    if(nfl_status() == 200)
      ...
      observeEvent(nflload_data_pre(),{
        ...
        if(nflload_data_mean_prcnt() < 0){
          ...
          output$NFL_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(nflload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }
        if(nflload_data_mean_prcnt() > 0){
          removeClass("nflmean","red_output")
          addClass("nflmean","green_output")
          output$NFL_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(nflload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }})
      ...
      output$NFL_load <- renderUI({
        highchart(height = 400) %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nfl_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>%
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
...
#start Alberta
  ...
  #print.default("Inside Alberta$$$$")
  check_ab_stat_api <- function(){status_api("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",NULL,NULL,1)}
  get_ab_stat_api <- function(){status_api("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",NULL,NULL,1)}
  ab_stat_api <- reactivePoll(intervalMillis = 1800000, session = session,
                              checkFunc = check_ab_stat_api, valueFunc = get_ab_stat_api)
  #print.default("Alberta API working until here")
  ab_status <- reactive({ab_stat_api()})
  observeEvent(ab_stat_api(),{
    if(ab_status() == 200)
    {
        #print.default("Alberta API entering IF")
      ab_api_stat <<- reactive({HTML(paste("<i style='color:green; font-style:italic;'> Okay:",ab_status(),"</i>"))})
      test_ab_dat <<- dataset("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",NULL,NULL,1) %>% arrange(desc(DATETIME_LOCAL)) %>% collect()
      ...
      {
        check_db_ab <- function(){dataset("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",sdmx_date_start,sdmx_date_end,NULL) %>% count(DATETIME_LOCAL)}
        get_db_ab <- function(){dataset("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",sdmx_date_start,sdmx_date_end,NULL) %>% arrange(desc(DATETIME_LOCAL)) %>% collect()}
        log_success("Using Latest Data for AB")
        ab_src_stat <<- reactive({HTML("<i style='color:green; font-style:italic;'> Okay</i>")})
      }
      else
      {
          #print.default("Alberta API entering ELSE")
        check_db_ab <- function(){dataset("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",NULL,NULL,10) %>% count(DATETIME_LOCAL)}
        get_db_ab <- function(){dataset("DF_HFED_AB","CA_AB","N","INTERNAL_LOAD",NULL,NULL,10) %>% arrange(desc(DATETIME_LOCAL)) %>% collect()}
      ...
      observeEvent(abload_data_pre(),{
        ...
        if(abload_data_mean_prcnt() < 0){
          ...
          output$AB_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(abload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }
        else if(abload_data_mean_prcnt() > 0){
          removeClass("abmean","red_output")
          addClass("abmean","green_output")
          output$AB_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(abload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }})
      abload_sub <- reactive({abload_data()})
      abload_subset <- reactive({subset(abload_sub(),subset = (abload_sub()$REF_AREA == "CA_AB"))})
      ...
      output$AB_load <- renderUI({
        highchart(height = 400) %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(ab_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>%
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
...
#start front Quebec  
    ...
    if(qb_status() == 200)
      ...
      observeEvent(qbload_data_pre(),{
        ...
        if(qbload_data_mean_prcnt() < 0){
          ...
          output$QB_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-down'></i><span style='font-family:times new roman'>",abs(round(qbload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }
        if(qbload_data_mean_prcnt() > 0){
          removeClass("qbmean","red_output")
          addClass("qbmean","green_output")
          output$QB_MEAN <- renderUI({HTML(paste("<h4><i class='fa fa-arrow-up'></i><span style='font-family:times new roman'>",abs(round(qbload_data_mean_prcnt(),digits = 2)),i18n$t("% in last hour"),"</i></h4>"))})
        }})
      ...
      output$QB_load <- renderUI({
        highchart(height = 400) %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(qb_load_ts(), type = "line", name = i18n$t("Load: "), color = colour_code()) %>% 
          hc_plotOptions(series = list(turboThreshold = 1)) %>%
          hc_navigator(enabled = TRUE)})
    ...
    if(pei_status_ind() == 200){
      ...
      output$PEI_ON_LOAD_YEARLY <- renderUI({
        highchart() %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(pei_ind_dat_ts_yearly()[,(colnames(pei_ind_dat_ts_yearly()) %in% c('pei_ind_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = colour_code_pei_1()) %>%
      ...
      output$PEI_ON_LOAD_WEEKLY <- renderUI({
        highchart() %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(pei_ind_dat_ts_weekly()[,(colnames(pei_ind_dat_ts_weekly()) %in% c('pei_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = colour_code_pei_1()) %>%
      ...
      output$PEI_ON_LOAD_DAILY <- renderUI({
        highchart() %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(pei_ind_dat_ts_daily()[,(colnames(pei_ind_dat_ts_daily()) %in% c('pei_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = colour_code_pei_1()) %>%
      ...
      output$PEI_ON_LOAD_HOURLY <- renderUI({
        highchart() %>%
          hc_xAxis(type = "datetime") %>%
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(pei_ind_dat_ts_hourly()[,(colnames(pei_ind_dat_ts_hourly()) %in% c('pei_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = colour_code_pei_1()) %>%
      ...
      output$PEI_ON_WIND_ALL <- renderUI({
        highchart() %>%
          ...
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_navigator(enabled = TRUE) %>%
          hc_add_series(pei_ind_subset_ts_2(), type = "line", name = "Wind Generation", color = colour_code_pei_1())%>%
          hc_add_series(pei_ind_subset_ts_2_fossil(), type = "line", name = "Fossil Fueled Generation", color = colour_code_pei_2())
      })
      ...
      output$PEI_EXPORT_ALL <- renderUI({
        highchart() %>% 
          ...
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_navigator(enabled = TRUE) %>% 
          hc_add_series(pei_exp_subset_ts(), type = "line", name = "Exported off-Island", color = colour_code_pei_1()) %>%
          hc_add_series(pei_exp_local_subset_ts(), type = "line", name = "Used on-Island", color = colour_code_pei_2())
      })
      ...
      output$PEI_LOCAL_ALL <- renderUI({
        highchart() %>% 
          ...
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_navigator(enabled = TRUE) %>% 
          hc_add_series(pei_loc_subset_ts(), type = "line", name = "Percentage of load generated from wind", color = colour_code_pei_1())
      })
    }  
    else if(pei_status() != 200)
    {
    ...
    if(nb_status_ind() == 200){
      ...
      output$NB_LOAD_YEARLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_ind_dat_ts_yearly()[,(colnames(nb_ind_dat_ts_yearly()) %in% c('nb_ind_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
          hc_add_series(nb_ind_dat_ts_yearly()[,(colnames(nb_ind_dat_ts_yearly()) %in% c('nb_ind_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_LOAD_WEEKLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_ind_dat_ts_weekly()[,(colnames(nb_ind_dat_ts_weekly()) %in% c('nb_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
          hc_add_series(nb_ind_dat_ts_weekly()[,(colnames(nb_ind_dat_ts_weekly()) %in% c('nb_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_LOAD_DAILY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_ind_dat_ts_daily()[,(colnames(nb_ind_dat_ts_daily()) %in% c('nb_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
          hc_add_series(nb_ind_dat_ts_daily()[,(colnames(nb_ind_dat_ts_daily()) %in% c('nb_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_LOAD_HOURLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_ind_dat_ts_hourly()[,(colnames(nb_ind_dat_ts_hourly()) %in% c('nb_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
          hc_add_series(nb_ind_dat_ts_hourly()[,(colnames(nb_ind_dat_ts_hourly()) %in% c('nb_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_LOAD_ALL <- renderUI({
        highchart() %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
          hc_add_series(nb_ind_subset_ts(), type = "line", name = i18n$t("High Load"), color = "lightgreen")
      })
      ...
      output$NB_RESERVE2_YEARLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_30_dat_ts_yearly()[,(colnames(nb_30_dat_ts_yearly()) %in% c('nb_30_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
          hc_add_series(nb_30_dat_ts_yearly()[,(colnames(nb_30_dat_ts_yearly()) %in% c('nb_30_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_RESERVE2_WEEKLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_30_dat_ts_weekly()[,(colnames(nb_30_dat_ts_weekly()) %in% c('nb_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
          hc_add_series(nb_30_dat_ts_weekly()[,(colnames(nb_30_dat_ts_weekly()) %in% c('nb_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_RESERVE2_DAILY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_30_dat_ts_daily()[,(colnames(nb_30_dat_ts_daily()) %in% c('nb_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
          hc_add_series(nb_30_dat_ts_daily()[,(colnames(nb_30_dat_ts_daily()) %in% c('nb_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_RESERVE2_HOURLY <- renderUI({
        highchart() %>% 
          hc_xAxis(type = "datetime") %>% 
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_add_series(nb_30_dat_ts_hourly()[,(colnames(nb_30_dat_ts_hourly()) %in% c('nb_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
          hc_add_series(nb_30_dat_ts_hourly()[,(colnames(nb_30_dat_ts_hourly()) %in% c('nb_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
          hc_navigator(enabled = TRUE)})
      output$NB_RESERVE2_ALL <- renderUI({
        highchart() %>% 
          ...
          hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
          hc_navigator(enabled = TRUE) %>% 
          hc_add_series(nb_30_subset_ts(), type = "line", name = i18n$t("High Load"), color = "lightgreen")
      })
    }  
    else if(nb_status() != 200)
    {
  ...
  {
    #Newfoundland and Labrador START
    st_tm_dsh_nfl <- Sys.time()
      ...
      if(nfl_status_ind() == 200){
        ...
        output$NFL_LOAD_YEARLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(nfl_load_dat_ts_yearly()[,(colnames(nfl_load_dat_ts_yearly()) %in% c('nfl_load_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(nfl_load_dat_ts_yearly()[,(colnames(nfl_load_dat_ts_yearly()) %in% c('nfl_load_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NFL_LOAD_WEEKLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(nfl_load_dat_ts_weekly()[,(colnames(nfl_load_dat_ts_weekly()) %in% c('nfl_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(nfl_load_dat_ts_weekly()[,(colnames(nfl_load_dat_ts_weekly()) %in% c('nfl_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NFL_LOAD_DAILY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(nfl_load_dat_ts_daily()[,(colnames(nfl_load_dat_ts_daily()) %in% c('nfl_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(nfl_load_dat_ts_daily()[,(colnames(nfl_load_dat_ts_daily()) %in% c('nfl_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NFL_LOAD_HOURLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(nfl_load_dat_ts_hourly()[,(colnames(nfl_load_dat_ts_hourly()) %in% c('nfl_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(nfl_load_dat_ts_hourly()[,(colnames(nfl_load_dat_ts_hourly()) %in% c('nfl_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NFL_LOAD_ALL <- renderUI({
          highchart() %>% 
            ...
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_navigator(enabled = TRUE) %>% 
            hc_add_series(nfl_load_subset_ts(), type = "line", name = i18n$t("High Load"), color = "green")
        })
      }
      ...
      if(bc_status_ind() == 200){
        ...
        output$BC_LOAD_YEARLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(bc_load_dat_ts_yearly()[,(colnames(bc_load_dat_ts_yearly()) %in% c('bc_load_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(bc_load_dat_ts_yearly()[,(colnames(bc_load_dat_ts_yearly()) %in% c('bc_load_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$BC_LOAD_WEEKLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(bc_load_dat_ts_weekly()[,(colnames(bc_load_dat_ts_weekly()) %in% c('bc_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(bc_load_dat_ts_weekly()[,(colnames(bc_load_dat_ts_weekly()) %in% c('bc_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$BC_LOAD_DAILY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(bc_load_dat_ts_daily()[,(colnames(bc_load_dat_ts_daily()) %in% c('bc_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(bc_load_dat_ts_daily()[,(colnames(bc_load_dat_ts_daily()) %in% c('bc_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$BC_LOAD_HOURLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(bc_load_dat_ts_hourly()[,(colnames(bc_load_dat_ts_hourly()) %in% c('bc_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(bc_load_dat_ts_hourly()[,(colnames(bc_load_dat_ts_hourly()) %in% c('bc_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$BC_LOAD_ALL <- renderUI({
          highchart() %>% 
            ...
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_navigator(enabled = TRUE) %>% 
            hc_add_series(bc_load_subset_ts(), type = "line", name = i18n$t("High Load"), color = "green")
        })
      }
      else if(bc_status() != 200)
      {
  ...
  # Nova Scotia START
      ...
      if(ns_status_ind() == 200){
        ...
        output$NS_LOAD_YEARLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_ind_dat_ts_yearly()[,(colnames(ns_ind_dat_ts_yearly()) %in% c('ns_ind_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
            hc_add_series(ns_ind_dat_ts_yearly()[,(colnames(ns_ind_dat_ts_yearly()) %in% c('ns_ind_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_LOAD_WEEKLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_ind_dat_ts_weekly()[,(colnames(ns_ind_dat_ts_weekly()) %in% c('ns_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
            hc_add_series(ns_ind_dat_ts_weekly()[,(colnames(ns_ind_dat_ts_weekly()) %in% c('ns_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_LOAD_DAILY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_ind_dat_ts_daily()[,(colnames(ns_ind_dat_ts_daily()) %in% c('ns_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
            hc_add_series(ns_ind_dat_ts_daily()[,(colnames(ns_ind_dat_ts_daily()) %in% c('ns_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_LOAD_HOURLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_ind_dat_ts_hourly()[,(colnames(ns_ind_dat_ts_hourly()) %in% c('ns_ind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
            hc_add_series(ns_ind_dat_ts_hourly()[,(colnames(ns_ind_dat_ts_hourly()) %in% c('ns_ind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_LOAD_ALL <- renderUI({
          highchart() %>% 
            ...
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_navigator(enabled = TRUE) %>% 
            hc_add_series(ns_ind_subset_ts(), type = "line", name = i18n$t("Load"), color = "lightgreen")
        })
        ...
        output$NS_NSI_YEARLY <- renderUI({
         highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_30_dat_ts_yearly()[,(colnames(ns_30_dat_ts_yearly()) %in% c('ns_30_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(ns_30_dat_ts_yearly()[,(colnames(ns_30_dat_ts_yearly()) %in% c('ns_30_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_NSI_WEEKLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_30_dat_ts_weekly()[,(colnames(ns_30_dat_ts_weekly()) %in% c('ns_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(ns_30_dat_ts_weekly()[,(colnames(ns_30_dat_ts_weekly()) %in% c('ns_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_NSI_DAILY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_30_dat_ts_daily()[,(colnames(ns_30_dat_ts_daily()) %in% c('ns_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(ns_30_dat_ts_daily()[,(colnames(ns_30_dat_ts_daily()) %in% c('ns_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_NSI_HOURLY <- renderUI({
          highchart() %>% 
            hc_xAxis(type = "datetime") %>% 
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_add_series(ns_30_dat_ts_hourly()[,(colnames(ns_30_dat_ts_hourly()) %in% c('ns_30_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
            hc_add_series(ns_30_dat_ts_hourly()[,(colnames(ns_30_dat_ts_hourly()) %in% c('ns_30_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
            hc_navigator(enabled = TRUE)})
        output$NS_NSI_ALL <- renderUI({
          highchart() %>% 
            ...
            hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
            hc_navigator(enabled = TRUE) %>% 
            hc_add_series(ns_30_subset_ts(), type = "line", name = i18n$t("Load"), color = "lightgreen")
        })
      }  
         ...
         if(on_status_ind() == 200){
           ...
           output$ON_LOAD_YEARLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>% 
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_load_dat_ts_yearly()[,(colnames(on_load_dat_ts_yearly()) %in% c('on_load_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_load_dat_ts_yearly()[,(colnames(on_load_dat_ts_yearly()) %in% c('on_load_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_LOAD_WEEKLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>% 
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_load_dat_ts_weekly()[,(colnames(on_load_dat_ts_weekly()) %in% c('on_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_load_dat_ts_weekly()[,(colnames(on_load_dat_ts_weekly()) %in% c('on_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_LOAD_DAILY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>% 
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_load_dat_ts_daily()[,(colnames(on_load_dat_ts_daily()) %in% c('on_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_load_dat_ts_daily()[,(colnames(on_load_dat_ts_daily()) %in% c('on_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_LOAD_HOURLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>% 
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_load_dat_ts_hourly()[,(colnames(on_load_dat_ts_hourly()) %in% c('on_load_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_load_dat_ts_hourly()[,(colnames(on_load_dat_ts_hourly()) %in% c('on_load_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_LOAD_ALL <- renderUI({
             highchart() %>%
               ...
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_navigator(enabled = TRUE) %>%
               hc_add_series(on_load_subset_ts(), type = "line", name = i18n$t("High Load"), color = "green")
           })
           ...
           output$ON_MRKTDMND_YEARLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>%
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_mrktdmd_dat_ts_yearly()[,(colnames(on_mrktdmd_dat_ts_yearly()) %in% c('on_mrktdmd_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_mrktdmd_dat_ts_yearly()[,(colnames(on_mrktdmd_dat_ts_yearly()) %in% c('on_mrktdmd_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_MRKTDMND_WEEKLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>%
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_mrktdmd_dat_ts_weekly()[,(colnames(on_mrktdmd_dat_ts_weekly()) %in% c('on_mrktdmd_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_mrktdmd_dat_ts_weekly()[,(colnames(on_mrktdmd_dat_ts_weekly()) %in% c('on_mrktdmd_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_MRKTDMND_DAILY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>%
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_mrktdmd_dat_ts_daily()[,(colnames(on_mrktdmd_dat_ts_daily()) %in% c('on_mrktdmd_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_mrktdmd_dat_ts_daily()[,(colnames(on_mrktdmd_dat_ts_daily()) %in% c('on_mrktdmd_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_MRKTDMND_HOURLY <- renderUI({
             highchart() %>%
               hc_xAxis(type = "datetime") %>%
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_add_series(on_mrktdmd_dat_ts_hourly()[,(colnames(on_mrktdmd_dat_ts_hourly()) %in% c('on_mrktdmd_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
               hc_add_series(on_mrktdmd_dat_ts_hourly()[,(colnames(on_mrktdmd_dat_ts_hourly()) %in% c('on_mrktdmd_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
               hc_navigator(enabled = TRUE)})
           output$ON_MRKTDMND_ALL <- renderUI({
             highchart() %>%
               ...
               hc_yAxis(title = list(text = "MW"),labels = list(style = list(color = "black", 'font-style' = "bold", 'font-size' = "small"))) %>%
               hc_navigator(enabled = TRUE) %>%
               hc_add_series(on_mrktdmd_subset_ts(), type = "line", name = i18n$t("High Load"), color = "green")
           })
         }
         else if(on_status() != 200)
         {
      ...
      observeEvent(qb_stat_api_ind(),{
        if(qb_status_ind() == 200){
          ...
          output$QB_DEMAND_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_demand_dat_ts_yearly()[,(colnames(qb_ind_demand_dat_ts_yearly()) %in% c('qb_ind_demand_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_demand_dat_ts_yearly()[,(colnames(qb_ind_demand_dat_ts_yearly()) %in% c('qb_ind_demand_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_DEMAND_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_demand_dat_ts_weekly()[,(colnames(qb_ind_demand_dat_ts_weekly()) %in% c('qb_ind_demand_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_demand_dat_ts_weekly()[,(colnames(qb_ind_demand_dat_ts_weekly()) %in% c('qb_ind_demand_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE)})
          output$QB_DEMAND_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_demand_dat_ts_daily()[,(colnames(qb_ind_demand_dat_ts_daily()) %in% c('qb_ind_demand_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_demand_dat_ts_daily()[,(colnames(qb_ind_demand_dat_ts_daily()) %in% c('qb_ind_demand_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_DEMAND_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_demand_dat_ts_hourly()[,(colnames(qb_ind_demand_dat_ts_hourly()) %in% c('qb_ind_demand_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_demand_dat_ts_hourly()[,(colnames(qb_ind_demand_dat_ts_hourly()) %in% c('qb_ind_demand_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_HYDRO_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_hydro_dat_ts_yearly()[,(colnames(qb_ind_hydro_dat_ts_yearly()) %in% c('qb_ind_hydro_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_hydro_dat_ts_yearly()[,(colnames(qb_ind_hydro_dat_ts_yearly()) %in% c('qb_ind_hydro_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE)})
          output$QB_HYDRO_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_hydro_dat_ts_weekly()[,(colnames(qb_ind_hydro_dat_ts_weekly()) %in% c('qb_ind_hydro_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_hydro_dat_ts_weekly()[,(colnames(qb_ind_hydro_dat_ts_weekly()) %in% c('qb_ind_hydro_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE)})
          output$QB_HYDRO_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_hydro_dat_ts_daily()[,(colnames(qb_ind_hydro_dat_ts_daily()) %in% c('qb_ind_hydro_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_hydro_dat_ts_daily()[,(colnames(qb_ind_hydro_dat_ts_daily()) %in% c('qb_ind_hydro_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_HYDRO_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_hydro_dat_ts_hourly()[,(colnames(qb_ind_hydro_dat_ts_hourly()) %in% c('qb_ind_hydro_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_hydro_dat_ts_hourly()[,(colnames(qb_ind_hydro_dat_ts_hourly()) %in% c('qb_ind_hydro_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_OTHER_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_other_dat_ts_yearly()[,(colnames(qb_ind_other_dat_ts_yearly()) %in% c('qb_ind_other_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_other_dat_ts_yearly()[,(colnames(qb_ind_other_dat_ts_yearly()) %in% c('qb_ind_other_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_OTHER_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_other_dat_ts_weekly()[,(colnames(qb_ind_other_dat_ts_weekly()) %in% c('qb_ind_other_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_other_dat_ts_weekly()[,(colnames(qb_ind_other_dat_ts_weekly()) %in% c('qb_ind_other_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_OTHER_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_other_dat_ts_daily()[,(colnames(qb_ind_other_dat_ts_daily()) %in% c('qb_ind_other_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_other_dat_ts_daily()[,(colnames(qb_ind_other_dat_ts_daily()) %in% c('qb_ind_other_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_OTHER_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_other_dat_ts_hourly()[,(colnames(qb_ind_other_dat_ts_hourly()) %in% c('qb_ind_other_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_other_dat_ts_hourly()[,(colnames(qb_ind_other_dat_ts_hourly()) %in% c('qb_ind_other_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_SOLAR_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_solar_dat_ts_yearly()[,(colnames(qb_ind_solar_dat_ts_yearly()) %in% c('qb_ind_solar_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_solar_dat_ts_yearly()[,(colnames(qb_ind_solar_dat_ts_yearly()) %in% c('qb_ind_solar_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_SOLAR_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_solar_dat_ts_weekly()[,(colnames(qb_ind_solar_dat_ts_weekly()) %in% c('qb_ind_solar_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_solar_dat_ts_weekly()[,(colnames(qb_ind_solar_dat_ts_weekly()) %in% c('qb_ind_solar_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_SOLAR_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_solar_dat_ts_daily()[,(colnames(qb_ind_solar_dat_ts_daily()) %in% c('qb_ind_solar_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_solar_dat_ts_daily()[,(colnames(qb_ind_solar_dat_ts_daily()) %in% c('qb_ind_solar_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_SOLAR_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_solar_dat_ts_hourly()[,(colnames(qb_ind_solar_dat_ts_hourly()) %in% c('qb_ind_solar_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_solar_dat_ts_hourly()[,(colnames(qb_ind_solar_dat_ts_hourly()) %in% c('qb_ind_solar_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_THERMAL_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_thermal_dat_ts_yearly()[,(colnames(qb_ind_thermal_dat_ts_yearly()) %in% c('qb_ind_thermal_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_thermal_dat_ts_yearly()[,(colnames(qb_ind_thermal_dat_ts_yearly()) %in% c('qb_ind_thermal_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_THERMAL_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_thermal_dat_ts_weekly()[,(colnames(qb_ind_thermal_dat_ts_weekly()) %in% c('qb_ind_thermal_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_thermal_dat_ts_weekly()[,(colnames(qb_ind_thermal_dat_ts_weekly()) %in% c('qb_ind_thermal_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_THERMAL_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_thermal_dat_ts_daily()[,(colnames(qb_ind_thermal_dat_ts_daily()) %in% c('qb_ind_thermal_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_thermal_dat_ts_daily()[,(colnames(qb_ind_thermal_dat_ts_daily()) %in% c('qb_ind_thermal_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_THERMAL_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_thermal_dat_ts_hourly()[,(colnames(qb_ind_thermal_dat_ts_hourly()) %in% c('qb_ind_thermal_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_thermal_dat_ts_hourly()[,(colnames(qb_ind_thermal_dat_ts_hourly()) %in% c('qb_ind_thermal_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_TOTPROD_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_totprod_dat_ts_yearly()[,(colnames(qb_ind_totprod_dat_ts_yearly()) %in% c('qb_ind_totprod_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_totprod_dat_ts_yearly()[,(colnames(qb_ind_totprod_dat_ts_yearly()) %in% c('qb_ind_totprod_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_TOTPROD_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_totprod_dat_ts_weekly()[,(colnames(qb_ind_totprod_dat_ts_weekly()) %in% c('qb_ind_totprod_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_totprod_dat_ts_weekly()[,(colnames(qb_ind_totprod_dat_ts_weekly()) %in% c('qb_ind_totprod_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_TOTPROD_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_totprod_dat_ts_daily()[,(colnames(qb_ind_totprod_dat_ts_daily()) %in% c('qb_ind_totprod_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_totprod_dat_ts_daily()[,(colnames(qb_ind_totprod_dat_ts_daily()) %in% c('qb_ind_totprod_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_TOTPROD_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_totprod_dat_ts_hourly()[,(colnames(qb_ind_totprod_dat_ts_hourly()) %in% c('qb_ind_totprod_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_totprod_dat_ts_hourly()[,(colnames(qb_ind_totprod_dat_ts_hourly()) %in% c('qb_ind_totprod_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          ...
          output$QB_WIND_YEARLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_wind_dat_ts_yearly()[,(colnames(qb_ind_wind_dat_ts_yearly()) %in% c('qb_ind_wind_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_wind_dat_ts_yearly()[,(colnames(qb_ind_wind_dat_ts_yearly()) %in% c('qb_ind_wind_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_WIND_WEEKLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_wind_dat_ts_weekly()[,(colnames(qb_ind_wind_dat_ts_weekly()) %in% c('qb_ind_wind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_wind_dat_ts_weekly()[,(colnames(qb_ind_wind_dat_ts_weekly()) %in% c('qb_ind_wind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_WIND_DAILY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_wind_dat_ts_daily()[,(colnames(qb_ind_wind_dat_ts_daily()) %in% c('qb_ind_wind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_wind_dat_ts_daily()[,(colnames(qb_ind_wind_dat_ts_daily()) %in% c('qb_ind_wind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
          output$QB_WIND_HOURLY <- renderUI({
            highchart() %>%
              hc_xAxis(type = "datetime") %>%
              hc_add_series(qb_ind_wind_dat_ts_hourly()[,(colnames(qb_ind_wind_dat_ts_hourly()) %in% c('qb_ind_wind_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "lightgreen") %>%
              hc_add_series(qb_ind_wind_dat_ts_hourly()[,(colnames(qb_ind_wind_dat_ts_hourly()) %in% c('qb_ind_wind_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
              hc_navigator(enabled = TRUE) })
    ...
    if(input$rted_menu == "Dwn"){
      ...
      if(input$prvnc_list == "Newfoundland and Labrador")
       {
      ...
      else if(input$prvnc_list == "Prince Edward Island")
      {
        ...
        else if(input$prvnc_list == "Ontario")
        {
          # updateSelectInput(session,"enf_flow_on", choices = list("ONTARIO_DEMAND","MARKET_ONTARIO"),selected = "ONTARIO_DEMAND")
            updateSelectInput(session,"enf_flow_on", choices = list("ONTARIO_DEMAND"),selected = "ONTARIO_DEMAND")
        ...
        {
          updateSelectInput(session,"enf_flow_ab", choices = list("INTERNAL_LOAD","APL","CCES","COAL","COGENERATION","COMBINED_CYCLE","EDPI","FORTIS","GAS","HYDRO","ISD","LTH","RDR","WIND"),selected = "INTERNAL_LOAD")
          dataflow <- reactive({"DF_HFED_AB"})
          prvnc_code <- reactive({"CA_AB"})
          var_choice <- reactive({input$enf_flow_ab})
          ab_dwnld_data <- download_api(dataflow(),prvnc_code(),"N",var_choice(),NULL,NULL,1,1) %>% arrange(desc(DATETIME_LOCAL))
          ...
          ab_user_data <- reactive({dataset("DF_HFED_AB","CA_AB","N",input$enf_flow_ab,ab_dwnld_date_1(),ab_dwnld_date_2(),NULL)})
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly()[,(colnames(qb_data_energy_dat_ts_yearly()) %in% c('qb_data_energy_dat_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly()[,(colnames(qb_data_energy_dat_ts_yearly()) %in% c('qb_data_energy_dat_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_TOT_PRODUCTION_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly()[,(colnames(qb_data_energy_dat_ts_weekly()) %in% c('qb_data_energy_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly()[,(colnames(qb_data_energy_dat_ts_weekly()) %in% c('qb_data_energy_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_TOT_PRODUCTION_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily()[,(colnames(qb_data_energy_dat_ts_daily()) %in% c('qb_data_energy_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily()[,(colnames(qb_data_energy_dat_ts_daily()) %in% c('qb_data_energy_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_TOT_PRODUCTION_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly()[,(colnames(qb_data_energy_dat_ts_hourly()) %in% c('qb_data_energy_subset_ts().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly()[,(colnames(qb_data_energy_dat_ts_hourly()) %in% c('qb_data_energy_subset_ts().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_TOT_PRODUCTION_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
#   qb_date_ind_2_1 <- reactive({paste(input$qb_dates_2[1],"00:00:00",sep = " ")})
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_1()[,(colnames(qb_data_energy_dat_ts_yearly_1()) %in% c('qb_data_energy_dat_ts_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_1()[,(colnames(qb_data_energy_dat_ts_yearly_1()) %in% c('qb_data_energy_dat_ts_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_2()[,(colnames(qb_data_energy_dat_ts_yearly_2()) %in% c('qb_data_energy_dat_ts_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_2()[,(colnames(qb_data_energy_dat_ts_yearly_2()) %in% c('qb_data_energy_dat_ts_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_1_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_1()[,(colnames(qb_data_energy_dat_ts_weekly_1()) %in% c('qb_data_energy_subset_ts_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_1()[,(colnames(qb_data_energy_dat_ts_weekly_1()) %in% c('qb_data_energy_subset_ts_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_2()[,(colnames(qb_data_energy_dat_ts_weekly_2()) %in% c('qb_data_energy_subset_ts_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_2()[,(colnames(qb_data_energy_dat_ts_weekly_2()) %in% c('qb_data_energy_subset_ts_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_1_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_1()[,(colnames(qb_data_energy_dat_ts_daily_1()) %in% c('qb_data_energy_subset_ts_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_1()[,(colnames(qb_data_energy_dat_ts_daily_1()) %in% c('qb_data_energy_subset_ts_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_2()[,(colnames(qb_data_energy_dat_ts_daily_2()) %in% c('qb_data_energy_subset_ts_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_2()[,(colnames(qb_data_energy_dat_ts_daily_2()) %in% c('qb_data_energy_subset_ts_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_1_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_1()[,(colnames(qb_data_energy_dat_ts_hourly_1()) %in% c('qb_data_energy_subset_ts_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_1()[,(colnames(qb_data_energy_dat_ts_hourly_1()) %in% c('qb_data_energy_subset_ts_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_2()[,(colnames(qb_data_energy_dat_ts_hourly_2()) %in% c('qb_data_energy_subset_ts_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_2()[,(colnames(qb_data_energy_dat_ts_hourly_2()) %in% c('qb_data_energy_subset_ts_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_1_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_1(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_2(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   qb_date_ind_3_1 <- reactive({paste(input$qb_dates_3[1],"00:00:00",sep = " ")})
#   qb_date_ind_3_2 <- reactive({paste(input$qb_dates_3[2],"00:00:00",sep = " ")})
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_3()[,(colnames(qb_data_energy_dat_ts_yearly_3()) %in% c('qb_data_energy_dat_ts_3().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_3()[,(colnames(qb_data_energy_dat_ts_yearly_3()) %in% c('qb_data_energy_dat_ts_3().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_4()[,(colnames(qb_data_energy_dat_ts_yearly_4()) %in% c('qb_data_energy_dat_ts_4().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_4()[,(colnames(qb_data_energy_dat_ts_yearly_4()) %in% c('qb_data_energy_dat_ts_4().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_2_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_3()[,(colnames(qb_data_energy_dat_ts_weekly_3()) %in% c('qb_data_energy_subset_ts_3().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_3()[,(colnames(qb_data_energy_dat_ts_weekly_3()) %in% c('qb_data_energy_subset_ts_3().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_4()[,(colnames(qb_data_energy_dat_ts_weekly_4()) %in% c('qb_data_energy_subset_ts_4().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_4()[,(colnames(qb_data_energy_dat_ts_weekly_4()) %in% c('qb_data_energy_subset_ts_4().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_2_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_3()[,(colnames(qb_data_energy_dat_ts_daily_3()) %in% c('qb_data_energy_subset_ts_3().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_3()[,(colnames(qb_data_energy_dat_ts_daily_3()) %in% c('qb_data_energy_subset_ts_3().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_4()[,(colnames(qb_data_energy_dat_ts_daily_4()) %in% c('qb_data_energy_subset_ts_4().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_4()[,(colnames(qb_data_energy_dat_ts_daily_4()) %in% c('qb_data_energy_subset_ts_4().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_2_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_3()[,(colnames(qb_data_energy_dat_ts_hourly_3()) %in% c('qb_data_energy_subset_ts_3().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_3()[,(colnames(qb_data_energy_dat_ts_hourly_3()) %in% c('qb_data_energy_subset_ts_3().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_4()[,(colnames(qb_data_energy_dat_ts_hourly_4()) %in% c('qb_data_energy_subset_ts_4().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_4()[,(colnames(qb_data_energy_dat_ts_hourly_4()) %in% c('qb_data_energy_subset_ts_4().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_2_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_3(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_4(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   qb_date_ind_4_1 <- reactive({paste(input$qb_dates_4[1],"00:00:00",sep = " ")})
#   qb_date_ind_4_2 <- reactive({paste(input$qb_dates_4[2],"00:00:00",sep = " ")})
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_5()[,(colnames(qb_data_energy_dat_ts_yearly_5()) %in% c('qb_data_energy_dat_ts_5().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_5()[,(colnames(qb_data_energy_dat_ts_yearly_5()) %in% c('qb_data_energy_dat_ts_5().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_3_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_5()[,(colnames(qb_data_energy_dat_ts_weekly_5()) %in% c('qb_data_energy_subset_ts_5().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_5()[,(colnames(qb_data_energy_dat_ts_weekly_5()) %in% c('qb_data_energy_subset_ts_5().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_3_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_5()[,(colnames(qb_data_energy_dat_ts_daily_5()) %in% c('qb_data_energy_subset_ts_5().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_5()[,(colnames(qb_data_energy_dat_ts_daily_5()) %in% c('qb_data_energy_subset_ts_5().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_3_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_5()[,(colnames(qb_data_energy_dat_ts_hourly_5()) %in% c('qb_data_energy_subset_ts_5().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_5()[,(colnames(qb_data_energy_dat_ts_hourly_5()) %in% c('qb_data_energy_subset_ts_5().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_FUEL_3_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_5(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   qb_date_ind_5_1 <- reactive({paste(input$qb_dates_5[1],"00:00:00",sep = " ")})
#   qb_date_ind_5_2 <- reactive({paste(input$qb_dates_5[2],"00:00:00",sep = " ")})
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_6()[,(colnames(qb_data_energy_dat_ts_yearly_6()) %in% c('qb_data_energy_dat_ts_6().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_6()[,(colnames(qb_data_energy_dat_ts_yearly_6()) %in% c('qb_data_energy_dat_ts_6().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_6_1()[,(colnames(qb_data_energy_dat_ts_yearly_6_1()) %in% c('qb_data_energy_dat_ts_6_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_6_1()[,(colnames(qb_data_energy_dat_ts_yearly_6_1()) %in% c('qb_data_energy_dat_ts_6_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_1_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_6()[,(colnames(qb_data_energy_dat_ts_weekly_6()) %in% c('qb_data_energy_subset_ts_6().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_6()[,(colnames(qb_data_energy_dat_ts_weekly_6()) %in% c('qb_data_energy_subset_ts_6().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_6_1()[,(colnames(qb_data_energy_dat_ts_weekly_6_1()) %in% c('qb_data_energy_subset_ts_6_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_6_1()[,(colnames(qb_data_energy_dat_ts_weekly_6_1()) %in% c('qb_data_energy_subset_ts_6_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_1_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_6()[,(colnames(qb_data_energy_dat_ts_daily_6()) %in% c('qb_data_energy_subset_ts_6().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_6()[,(colnames(qb_data_energy_dat_ts_daily_6()) %in% c('qb_data_energy_subset_ts_6().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_6_1()[,(colnames(qb_data_energy_dat_ts_daily_6_1()) %in% c('qb_data_energy_subset_ts_6_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_6_1()[,(colnames(qb_data_energy_dat_ts_daily_6_1()) %in% c('qb_data_energy_subset_ts_6_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_1_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_6()[,(colnames(qb_data_energy_dat_ts_hourly_6()) %in% c('qb_data_energy_subset_ts_6().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_6()[,(colnames(qb_data_energy_dat_ts_hourly_6()) %in% c('qb_data_energy_subset_ts_6().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_6_1()[,(colnames(qb_data_energy_dat_ts_hourly_6_1()) %in% c('qb_data_energy_subset_ts_6_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_6_1()[,(colnames(qb_data_energy_dat_ts_hourly_6_1()) %in% c('qb_data_energy_subset_ts_6_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_1_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_6(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_6_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_7()[,(colnames(qb_data_energy_dat_ts_yearly_7()) %in% c('qb_data_energy_dat_ts_7().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_7()[,(colnames(qb_data_energy_dat_ts_yearly_7()) %in% c('qb_data_energy_dat_ts_7().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_7_1()[,(colnames(qb_data_energy_dat_ts_yearly_7_1()) %in% c('qb_data_energy_dat_ts_7_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_7_1()[,(colnames(qb_data_energy_dat_ts_yearly_7_1()) %in% c('qb_data_energy_dat_ts_7_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_2_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_7()[,(colnames(qb_data_energy_dat_ts_weekly_7()) %in% c('qb_data_energy_subset_ts_7().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_7()[,(colnames(qb_data_energy_dat_ts_weekly_7()) %in% c('qb_data_energy_subset_ts_7().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_7_1()[,(colnames(qb_data_energy_dat_ts_weekly_7_1()) %in% c('qb_data_energy_subset_ts_7_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_7_1()[,(colnames(qb_data_energy_dat_ts_weekly_7_1()) %in% c('qb_data_energy_subset_ts_7_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_2_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_7()[,(colnames(qb_data_energy_dat_ts_daily_7()) %in% c('qb_data_energy_subset_ts_7().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_7()[,(colnames(qb_data_energy_dat_ts_daily_7()) %in% c('qb_data_energy_subset_ts_7().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_7_1()[,(colnames(qb_data_energy_dat_ts_daily_7_1()) %in% c('qb_data_energy_subset_ts_7_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_7_1()[,(colnames(qb_data_energy_dat_ts_daily_7_1()) %in% c('qb_data_energy_subset_ts_7_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_2_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_7()[,(colnames(qb_data_energy_dat_ts_hourly_7()) %in% c('qb_data_energy_subset_ts_7().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_7()[,(colnames(qb_data_energy_dat_ts_hourly_7()) %in% c('qb_data_energy_subset_ts_7().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_7_1()[,(colnames(qb_data_energy_dat_ts_hourly_7_1()) %in% c('qb_data_energy_subset_ts_7_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_7_1()[,(colnames(qb_data_energy_dat_ts_hourly_7_1()) %in% c('qb_data_energy_subset_ts_7_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_2_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_7(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_7_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_8()[,(colnames(qb_data_energy_dat_ts_yearly_8()) %in% c('qb_data_energy_dat_ts_8().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_8()[,(colnames(qb_data_energy_dat_ts_yearly_8()) %in% c('qb_data_energy_dat_ts_8().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_8_1()[,(colnames(qb_data_energy_dat_ts_yearly_8_1()) %in% c('qb_data_energy_dat_ts_8_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_8_1()[,(colnames(qb_data_energy_dat_ts_yearly_8_1()) %in% c('qb_data_energy_dat_ts_8_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_3_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_8()[,(colnames(qb_data_energy_dat_ts_weekly_8()) %in% c('qb_data_energy_subset_ts_8().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_8()[,(colnames(qb_data_energy_dat_ts_weekly_8()) %in% c('qb_data_energy_subset_ts_8().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_8_1()[,(colnames(qb_data_energy_dat_ts_weekly_8_1()) %in% c('qb_data_energy_subset_ts_8_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_8_1()[,(colnames(qb_data_energy_dat_ts_weekly_8_1()) %in% c('qb_data_energy_subset_ts_8_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_3_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_8()[,(colnames(qb_data_energy_dat_ts_daily_8()) %in% c('qb_data_energy_subset_ts_8().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_8()[,(colnames(qb_data_energy_dat_ts_daily_8()) %in% c('qb_data_energy_subset_ts_8().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_8_1()[,(colnames(qb_data_energy_dat_ts_daily_8_1()) %in% c('qb_data_energy_subset_ts_8_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_8_1()[,(colnames(qb_data_energy_dat_ts_daily_8_1()) %in% c('qb_data_energy_subset_ts_8_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_3_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_8()[,(colnames(qb_data_energy_dat_ts_hourly_8()) %in% c('qb_data_energy_subset_ts_8().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_8()[,(colnames(qb_data_energy_dat_ts_hourly_8()) %in% c('qb_data_energy_subset_ts_8().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_8_1()[,(colnames(qb_data_energy_dat_ts_hourly_8_1()) %in% c('qb_data_energy_subset_ts_8_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_8_1()[,(colnames(qb_data_energy_dat_ts_hourly_8_1()) %in% c('qb_data_energy_subset_ts_8_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_3_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_8(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_8_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_9()[,(colnames(qb_data_energy_dat_ts_yearly_9()) %in% c('qb_data_energy_dat_ts_9().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_9()[,(colnames(qb_data_energy_dat_ts_yearly_9()) %in% c('qb_data_energy_dat_ts_9().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_9_1()[,(colnames(qb_data_energy_dat_ts_yearly_9_1()) %in% c('qb_data_energy_dat_ts_9_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_9_1()[,(colnames(qb_data_energy_dat_ts_yearly_9_1()) %in% c('qb_data_energy_dat_ts_9_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_4_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_9()[,(colnames(qb_data_energy_dat_ts_weekly_9()) %in% c('qb_data_energy_subset_ts_9().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_9()[,(colnames(qb_data_energy_dat_ts_weekly_9()) %in% c('qb_data_energy_subset_ts_9().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_9_1()[,(colnames(qb_data_energy_dat_ts_weekly_9_1()) %in% c('qb_data_energy_subset_ts_9_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_9_1()[,(colnames(qb_data_energy_dat_ts_weekly_9_1()) %in% c('qb_data_energy_subset_ts_9_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_4_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_9()[,(colnames(qb_data_energy_dat_ts_daily_9()) %in% c('qb_data_energy_subset_ts_9().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_9()[,(colnames(qb_data_energy_dat_ts_daily_9()) %in% c('qb_data_energy_subset_ts_9().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_9_1()[,(colnames(qb_data_energy_dat_ts_daily_9_1()) %in% c('qb_data_energy_subset_ts_9_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_9_1()[,(colnames(qb_data_energy_dat_ts_daily_9_1()) %in% c('qb_data_energy_subset_ts_9_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_4_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_9()[,(colnames(qb_data_energy_dat_ts_hourly_9()) %in% c('qb_data_energy_subset_ts_9().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_9()[,(colnames(qb_data_energy_dat_ts_hourly_9()) %in% c('qb_data_energy_subset_ts_9().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_9_1()[,(colnames(qb_data_energy_dat_ts_hourly_9_1()) %in% c('qb_data_energy_subset_ts_9_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_9_1()[,(colnames(qb_data_energy_dat_ts_hourly_9_1()) %in% c('qb_data_energy_subset_ts_9_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_4_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_9(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_9_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_10()[,(colnames(qb_data_energy_dat_ts_yearly_10()) %in% c('qb_data_energy_dat_ts_10().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_10()[,(colnames(qb_data_energy_dat_ts_yearly_10()) %in% c('qb_data_energy_dat_ts_10().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_10_1()[,(colnames(qb_data_energy_dat_ts_yearly_10_1()) %in% c('qb_data_energy_dat_ts_10_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_10_1()[,(colnames(qb_data_energy_dat_ts_yearly_10_1()) %in% c('qb_data_energy_dat_ts_10_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_5_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_10()[,(colnames(qb_data_energy_dat_ts_weekly_10()) %in% c('qb_data_energy_subset_ts_10().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_10()[,(colnames(qb_data_energy_dat_ts_weekly_10()) %in% c('qb_data_energy_subset_ts_10().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_10_1()[,(colnames(qb_data_energy_dat_ts_weekly_10_1()) %in% c('qb_data_energy_subset_ts_10_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_10_1()[,(colnames(qb_data_energy_dat_ts_weekly_10_1()) %in% c('qb_data_energy_subset_ts_10_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_5_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_10()[,(colnames(qb_data_energy_dat_ts_daily_10()) %in% c('qb_data_energy_subset_ts_10().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_10()[,(colnames(qb_data_energy_dat_ts_daily_10()) %in% c('qb_data_energy_subset_ts_10().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_10_1()[,(colnames(qb_data_energy_dat_ts_daily_10_1()) %in% c('qb_data_energy_subset_ts_10_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_10_1()[,(colnames(qb_data_energy_dat_ts_daily_10_1()) %in% c('qb_data_energy_subset_ts_10_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_5_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_10()[,(colnames(qb_data_energy_dat_ts_hourly_10()) %in% c('qb_data_energy_subset_ts_10().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_10()[,(colnames(qb_data_energy_dat_ts_hourly_10()) %in% c('qb_data_energy_subset_ts_10().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_10_1()[,(colnames(qb_data_energy_dat_ts_hourly_10_1()) %in% c('qb_data_energy_subset_ts_10_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_10_1()[,(colnames(qb_data_energy_dat_ts_hourly_10_1()) %in% c('qb_data_energy_subset_ts_10_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_5_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_10(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_10_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_11()[,(colnames(qb_data_energy_dat_ts_yearly_11()) %in% c('qb_data_energy_dat_ts_11().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_11()[,(colnames(qb_data_energy_dat_ts_yearly_11()) %in% c('qb_data_energy_dat_ts_11().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_11_1()[,(colnames(qb_data_energy_dat_ts_yearly_11_1()) %in% c('qb_data_energy_dat_ts_11_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_11_1()[,(colnames(qb_data_energy_dat_ts_yearly_11_1()) %in% c('qb_data_energy_dat_ts_11_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_6_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_11()[,(colnames(qb_data_energy_dat_ts_weekly_11()) %in% c('qb_data_energy_subset_ts_11().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_11()[,(colnames(qb_data_energy_dat_ts_weekly_11()) %in% c('qb_data_energy_subset_ts_11().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_11_1()[,(colnames(qb_data_energy_dat_ts_weekly_11_1()) %in% c('qb_data_energy_subset_ts_11_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_11_1()[,(colnames(qb_data_energy_dat_ts_weekly_11_1()) %in% c('qb_data_energy_subset_ts_11_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_6_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_11()[,(colnames(qb_data_energy_dat_ts_daily_11()) %in% c('qb_data_energy_subset_ts_11().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_11()[,(colnames(qb_data_energy_dat_ts_daily_11()) %in% c('qb_data_energy_subset_ts_11().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_11_1()[,(colnames(qb_data_energy_dat_ts_daily_11_1()) %in% c('qb_data_energy_subset_ts_11_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_11_1()[,(colnames(qb_data_energy_dat_ts_daily_11_1()) %in% c('qb_data_energy_subset_ts_11_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_6_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_11()[,(colnames(qb_data_energy_dat_ts_hourly_11()) %in% c('qb_data_energy_subset_ts_11().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_11()[,(colnames(qb_data_energy_dat_ts_hourly_11()) %in% c('qb_data_energy_subset_ts_11().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_11_1()[,(colnames(qb_data_energy_dat_ts_hourly_11_1()) %in% c('qb_data_energy_subset_ts_11_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_11_1()[,(colnames(qb_data_energy_dat_ts_hourly_11_1()) %in% c('qb_data_energy_subset_ts_11_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_6_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_11(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_11_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   output$QB_ENE_8_YEARLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_11_2()[,(colnames(qb_data_energy_dat_ts_yearly_11_2()) %in% c('qb_data_energy_dat_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_11_2()[,(colnames(qb_data_energy_dat_ts_yearly_11_2()) %in% c('qb_data_energy_dat_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_8_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_11_2()[,(colnames(qb_data_energy_dat_ts_weekly_11_2()) %in% c('qb_data_energy_subset_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_11_2()[,(colnames(qb_data_energy_dat_ts_weekly_11_2()) %in% c('qb_data_energy_subset_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_8_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_11_2()[,(colnames(qb_data_energy_dat_ts_daily_11_2()) %in% c('qb_data_energy_subset_ts_11_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_11_2()[,(colnames(qb_data_energy_dat_ts_daily_11_2()) %in% c('qb_data_energy_subset_ts_11_2().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_8_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_11_2()[,(colnames(qb_data_energy_dat_ts_hourly_11_2()) %in% c('qb_data_energy_subset_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_11_2()[,(colnames(qb_data_energy_dat_ts_hourly_11_2()) %in% c('qb_data_energy_subset_ts_11_2().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_8_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_11_2(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
...
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_yearly_12()[,(colnames(qb_data_energy_dat_ts_yearly_12()) %in% c('qb_data_energy_dat_ts_12().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_12()[,(colnames(qb_data_energy_dat_ts_yearly_12()) %in% c('qb_data_energy_dat_ts_12().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_12_1()[,(colnames(qb_data_energy_dat_ts_yearly_12_1()) %in% c('qb_data_energy_dat_ts_12_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_yearly_12_1()[,(colnames(qb_data_energy_dat_ts_yearly_12_1()) %in% c('qb_data_energy_dat_ts_12_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_7_WEEKLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_weekly_12()[,(colnames(qb_data_energy_dat_ts_weekly_12()) %in% c('qb_data_energy_subset_ts_12().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_12()[,(colnames(qb_data_energy_dat_ts_weekly_12()) %in% c('qb_data_energy_subset_ts_12().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_12_1()[,(colnames(qb_data_energy_dat_ts_weekly_12_1()) %in% c('qb_data_energy_subset_ts_12_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_weekly_12_1()[,(colnames(qb_data_energy_dat_ts_weekly_12_1()) %in% c('qb_data_energy_subset_ts_12_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_7_DAILY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_daily_12()[,(colnames(qb_data_energy_dat_ts_daily_12()) %in% c('qb_data_energy_subset_ts_12().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_12()[,(colnames(qb_data_energy_dat_ts_daily_12()) %in% c('qb_data_energy_subset_ts_12().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_12_1()[,(colnames(qb_data_energy_dat_ts_daily_12_1()) %in% c('qb_data_energy_subset_ts_12_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_daily_12_1()[,(colnames(qb_data_energy_dat_ts_daily_12_1()) %in% c('qb_data_energy_subset_ts_12_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_7_HOURLY <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% 
#       hc_add_series(qb_data_energy_dat_ts_hourly_12()[,(colnames(qb_data_energy_dat_ts_hourly_12()) %in% c('qb_data_energy_subset_ts_12().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_12()[,(colnames(qb_data_energy_dat_ts_hourly_12()) %in% c('qb_data_energy_subset_ts_12().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_12_1()[,(colnames(qb_data_energy_dat_ts_hourly_12_1()) %in% c('qb_data_energy_subset_ts_12_1().High'))], type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_dat_ts_hourly_12_1()[,(colnames(qb_data_energy_dat_ts_hourly_12_1()) %in% c('qb_data_energy_subset_ts_12_1().Low'))], type = "line", name = i18n$t("Low Load"), color = "red") %>%
#       hc_navigator(enabled = TRUE)})
#   output$QB_ENE_7_ALL <- renderHighchart({
#     highchart() %>% 
#       hc_xAxis(type = "datetime") %>% hc_navigator(enabled = TRUE) %>% 
#       hc_add_series(qb_data_energy_subset_ts_12(), type = "line", name = i18n$t("High Load"), color = "green") %>%
#       hc_add_series(qb_data_energy_subset_ts_12_1(), type = "line", name = i18n$t("High Load"), color = "green")
#   })
#   
#   
#   
  ...
  output$DATA_DICTIONARY_NB <- renderDataTable({data_dict_df_nb})
    ...
    output$SERVER_STATUS <- renderUI({
      tags$table(
        ...
        tags$tr(
          tags$td("Newfoundland and Labrador"),
          tags$td(bc_api_stat()),
          tags$td(bc_src_stat())
        ),
        tags$tr(
